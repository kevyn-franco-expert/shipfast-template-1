...
const ButtonGetStarted = () => {
    ...
    return (
        <button
            className="btn btn-block group bg-[hsl(158,64%,52%)] hover:bg-[hsl(158,64%,45%)] text-white border-none shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
